...
- Name: mega-menu-forms.spec.js >> Database API Tests >> GET /api/pricing returns pricing array
- Location: tests/mega-menu-forms.spec.js:13:9
...
Call log:
  - → GET http://localhost:3003/api/pricing
